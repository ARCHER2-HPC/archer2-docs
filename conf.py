...
latex_documents = [
    (master_doc, 'ARCHER2.tex', u'ARCHER2 Draft Documentation',
     u'ARCHER2', 'manual'),
]
...
man_pages = [
    (master_doc, 'ARCHER2', u'ARCHER2 Draft Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ARCHER2', u'Draft ARCHER2 Documentation',
     author, 'ARCHER2 Team', 'ARCHER2 UK national supercomputing service.',
     'Miscellaneous'),
]
