# Running a simple case with CESM 2.1.3

If you are new to CESM2, please consider reading the
[CIME Case Control System Part 1: Basic Usage guide](https://esmci.github.io/cime/index.html) first.
...
See the [supported component sets](http://www.cesm.ucar.edu/models/cesm2/config/compsets.html), [supported model resolutions](http://www.cesm.ucar.edu/models/cesm2/config/grids.html) and [supported machines](http://www.cesm.ucar.edu/models/cesm2/config/machines.html) for a complete list of CESM2 supported component sets, grids and computational platforms.
