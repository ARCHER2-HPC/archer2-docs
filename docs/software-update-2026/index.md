...
-    [ORCA ](https://www.faccts.de/orca/) will be added to the list of supported software
-    [NWChem](https://www.nwchem-sw.org/) will be removed from the list of supported software (current installed versions will remain available on ARCHER2)
...
-    [VASP ](https://www.vasp.at/) Version 6.5.1 will be installed (and made the default). VASP 6.5.1 with VTST will also be installed.  
