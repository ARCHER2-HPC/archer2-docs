...
As the NSCDS/EPCCFS is based off a different authetication system then supports ARCHER2, you
...
of ARCHER2's file systems to another. One advantage of using `rclone` for this
